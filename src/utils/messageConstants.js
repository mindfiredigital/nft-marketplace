...
export const CHAIN_NOT_SUPPORTED_ERROR = "The chain you have connected is not supported by Fandom NFT Marketplace. Please connect to Mumbai Matic testnet in metamask to use Fandom NFT Marketplace!";
